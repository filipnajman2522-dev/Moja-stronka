...
{{ css|safe }}  
</head>  <body style="min-height:100vh;display:flex;align-items:center;justify-content:center">  <div class="form-box" style="width:400px;max-width:92%">  <h1 style="text-align:center">🔥 FilipHub</h1>  <p class="muted" style="text-align:center">  
Witaj ponownie  
</p>  {% if message %}

<div class="message">{{ message }}</div>  
{% endif %}  <form method="post">  <input
type="text"
name="username"
...
<button type="submit">  
Zaloguj się  
</button>  </form>  <p class="muted" style="text-align:center;margin-top:20px">  
Nie masz konta?  <a href="/register" style="color:#818cf8">  
Utwórz konto  
</a>  
</p>  </div>  </body>  
</html>  
...
Masz już konto?  <a href="/" style="color:#818cf8">  
Zaloguj się  
</a>  
</p>  </div>  </body>  
</html>  
...
<html lang="pl">  <head>  <meta charset="UTF-8">  <meta
name="viewport"
content="width=device-width,initial-scale=1"

> 

<title>FilipHub - Dashboard</title>  {{ css|safe }}

</head>  <body>  {{ sidebar|safe }}

<main class="main">  <div class="topbar">  <div>  <h1>Dashboard</h1>  <p class="muted">  
Centrum Twojego konta  
</p>  </div>  <div class="user">  {% if avatar %}
...
</div>  </div>  <section class="hero">  <h2>  
Witaj, {{ username }}! 👋  
</h2>  <p>  
Miło Cię widzieć w FilipHub.  
To jest Twoje centrum użytkownika.  
</p>  </section>  <div class="grid">  <div class="card">  <div class="card-icon">  
🚀  
</div>  <h3>  
Nowe funkcje  
</h3>  <p>  
...
nowe możliwości.  
</p>  </div>  <div class="card">  <div class="card-icon">  
👤  
</div>  <h3>  
Twój profil  
</h3>  <p>  
...
swoje hasło.  
</p>  </div>  </div>  <section class="quick">  <h2>  
Szybkie akcje  
</h2>  <a href="/profile">  
👤 Profil  
</a>  <a href="/edit-profile">  
✏️ Edytuj profil  
</a>  <a href="/change-password">  
🔐 Zmień hasło  
</a>  </section>  </main>  </body>  
</html>  
        """,  
...
<title>FilipHub - Profil</title>  {{ css|safe }}

</head>  <body>  {{ sidebar|safe }}

<main class="main">  <div class="topbar">  <h1>  
Twój profil  
</h1>  </div>  <div class="profile-card">  {% if avatar %}
...
Użytkownik FilipHub  
</div>  <div style="margin-top:25px">  <a class="btn" href="/edit-profile">  
✏️ Edytuj profil  
</a>  <a class="btn" href="/panel">  
🏠 Dashboard  
</a>  </div>  </div>  </main>  </body>  
</html>  
        """,  
...
<title>FilipHub - Edytuj profil</title>  {{ css|safe }}

</head>  <body>  {{ sidebar|safe }}

<main class="main">  <div class="topbar">  <h1>  
Edytuj profil  
</h1>  </div>  <div class="form-box">  {% if message %}

<div class="message">  
{{ message }}  
</div>  {% endif %}

<div style="text-align:center">  {% if current_avatar %}
...
<title>FilipHub - Zmień hasło</title>  {{ css|safe }}
